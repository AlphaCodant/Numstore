...
async def create_payment_session(
    ...
    await db.execute(
        """INSERT INTO payment_transactions
           (id, session_id, product_id, amount, currency, email, payment_status, access_code_sent, is_service,
            created_at)
        ...
        if transaction and not transaction["access_code_sent"]:
            ...
            if product:
                ...
                if is_service:
                    ...
                    await db.execute(
                        """INSERT INTO access_codes (id, code, product_id, email, order_id, created_at, expires_at,
                                                     is_used)
                    ...
                    return {"status": "paid", "email_sent": email_sent,
                            "message": f"Code envoyé à {transaction['email']}"}
